...
{
    /// <summary>
    /// Prueba de la clase <see cref="ShowInterestInOfferHandler"/>.
    /// </summary>
    [TestFixture]
    public class ShowInterestInOfferHandlerTests
    {   
        /// <summary>
        ...
        /// </summary>
        [Test]
        public void ShowInterestInOfferHandlerTest()
        {
            Message mensaje = new Message();
            mensaje.From = new User();
            mensaje.Text = "/interes_oferta";
            mensaje.From.Id = 321312751;
            ...
            IHandler firstHandler = new ShowInterestInOfferHandler(null);
