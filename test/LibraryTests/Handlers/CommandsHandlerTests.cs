...
{
    /// <summary>
    /// Prueba de la clase <see cref="CommandsHandler"/>.
    /// </summary>
    [TestFixture]
    ...
    {   
        ...
        /// </summary>
        [Test]
        public void CommandsHandlerTest()
        {
            Message mensaje = new Message();
            mensaje.From = new User();
            mensaje.Text = "/comandos";
            mensaje.From.Id = 234843128;
            ...
            IHandler firstHandler = new CommandsHandler(null);
