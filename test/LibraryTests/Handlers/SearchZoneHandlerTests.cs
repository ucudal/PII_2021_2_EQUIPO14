...
{
    /// <summary>
    /// Prueba de la clase <see cref="SearchZoneHandler"/>.
    /// </summary>
    [TestFixture]
    public class SearchZoneHandlerTests
    {   
        /// <summary>
        ...
        /// </summary>
        [Test]
        public void SearchZoneHandlerTest()
        {
            Message mensaje = new Message();
            mensaje.From = new User();
            mensaje.Text = "/buscar_zona";
            mensaje.From.Id = 434123175;
            ...
            IHandler firstHandler = new SearchZoneHandler(null);
