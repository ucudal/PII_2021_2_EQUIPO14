...
{
    /// <summary>
    /// Prueba de la clase <see cref="RecurrenciaHandler"/>.
    /// </summary>
    [TestFixture]
    public class SearchRecurrencyHandlerTests
    {   
        /// <summary>
        ...
        /// </summary>
        [Test]
        public void SearchRecurrencyHandlerTest()
        {
            Message mensaje = new Message();
            mensaje.From = new User();
            mensaje.Text = "/buscar_recurrencia";
            mensaje.From.Id = 653482314;
            ...
            IHandler firstHandler = new RecurrenciaHandler(null);
