...
{
    /// <summary>
    /// Prueba de la clase <see cref="SearchKeyWordsHandler"/>.
    /// </summary>
    [TestFixture]
    public class SearchKeyWordsHandlerTests
    {   
        /// <summary>
        ...
        /// </summary>
        [Test]
        public void SearchKeyWordsHandlerTest()
        {
            Message mensaje = new Message();
            mensaje.From = new User();
            mensaje.Text = "/buscar_palabra";
            ...
            IHandler firstHandler = new SearchKeyWordsHandler(null);
