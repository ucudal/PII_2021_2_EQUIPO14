...
{
    /// <summary>
    /// Prueba de la clase <see cref="PublishHandler"/>.
    /// </summary>
    [TestFixture]
    ...
    {   
        ...
        /// </summary>
        [Test]
        public void PublishHandlerTest()
        {
            Message mensaje = new Message();
            mensaje.From = new User();
            mensaje.Text = "/publicar";
            mensaje.From.Id = 532187512;
            ...
            IHandler firstHandler = new PublishHandler(null);
