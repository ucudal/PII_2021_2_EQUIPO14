...
{
    /// <summary>
    /// Prueba de la clase <see cref="EndOfferHandler"/>.
    /// </summary>
    [TestFixture]
    public class EndOfferHandlerTests
    {   
        /// <summary>
        ...
        /// </summary>
        [Test]
        public void EndOfferHandlerTest()
        {
            Message mensaje = new Message();
            mensaje.From = new User();
            mensaje.Text = "/concretar_publicacion";
            mensaje.From.Id = 341641761;
            ...
            IHandler firstHandler = new EndOfferHandler(null);
