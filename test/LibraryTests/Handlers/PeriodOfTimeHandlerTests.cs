...
{
    /// <summary>
    /// Prueba de la clase <see cref="PeriodOfTimeHandler"/>.
    /// </summary>
    [TestFixture]
    public class PeriodOfTimeHandlerTests
    {   
        /// <summary>
        ...
        /// </summary>
        [Test]
        public void PeriodOfTimeHandlerTest()
        {
            Message mensaje = new Message();
            mensaje.From = new User();
            mensaje.Text = "/ventas";
            mensaje.From.Id = 1239087;
            ...
            IHandler firstHandler = new PeriodOfTimeHandler(null);
