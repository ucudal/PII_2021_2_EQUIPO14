...
{
    /// <summary>
    /// Prueba de la clase <see cref="InviteHandler"/>.
    /// </summary>
    [TestFixture]
    ...
    {   
        ...
        /// </summary>
        [Test]
        public void InviteHandlerTest()
        {
            Message mensaje = new Message();
            mensaje.From = new User();
            mensaje.Text = "/invitar";
            mensaje.From.Id = 234123456;
            ...
            IHandler firstHandler = new InviteHandler(null);
